...
import { Row, Col, Flex, Typography, Input, Button } from "antd";
                ...
                <Flex gap="25px">
                  ...
                  >
                    <svg
                      ...
                      fill="none"
                    >
                      <rect width="43" height="43" rx="21.5" fill="#1C1C1C" />
                      <path
                    ...
                    <form className="footer-form-display">
                      ...
                      <Flex gap={10} style={{ marginTop: 10 }}>
                        <Input
                          ...
                          style={{ borderRadius: "0px" }}
                        />
                        <Button className="btn-sub-footer">
                          Submit my info
                        </Button>
                      </Flex>
                    </form>
